  ...
  return (
    <main className="live-workspace" id="main-content">
      ...
      <div className="live-input-grid">
        <section className="live-card"><span className="eyebrow">1 · Draft recommendation</span><h2><label htmlFor="draft-recommendation">AI-written memo</label></h2><p className="field-help" id="draft-recommendation-help">Paste the recommendation, including its reasoning and reported calculations.</p><textarea id="draft-recommendation" aria-describedby="draft-recommendation-help draft-recommendation-count" value={memo} onChange={(event) => setMemo(event.target.value)} placeholder="Paste the recommendation you want to test…" maxLength={120000} disabled={running} /><small id="draft-recommendation-count">{memo.length.toLocaleString()} / 120,000 characters</small></section>
